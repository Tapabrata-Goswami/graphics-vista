...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Graphics Vista</span>
    </a>
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg right">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" <?php echo base_url("assets/admin/dist/img/user3-128x128.jpg");?> alt="message user image">
                    <!-- /.direct-chat-img -->
                    <div class="direct-chat-text">
